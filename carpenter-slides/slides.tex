...
\item Stan is a Turing-complete imperative programming language \myemph{for specifying differentiable log densities} and \myemph{posterior predictive inferences}.
\begin{subitemize}
...
\sld{Reading and transforming data}
%
\begin{itemize}
...
\sld{Evaluating the log density}
%
\begin{itemize}
...
\end{subitemize}
\item Linear multiple of time to evaluate log density
\end{itemize}


\sld{Evaluating generated quantities}
%
\begin{itemize}
...
%
\\
\spc Variables and expressions are \myemph{strongly, statically typed}.
\begin{subitemize}
...
\item \myemph{Constrained Vectors}: {\tt\small simplex[K]}, \ {\tt\small
    ordered[N]}, {\tt\small pos\_ordered[N]}, {\tt\small sum\_to\_zero[K]}
...
\item \myemph{Constrained Matrices}: {\tt\small cov\_matrix[K]}, \ {\tt\small
  ...
  {\tt\small cholesky\_factor\_corr[K]}, \ {\tt\small row\_stochastic\_matrix[M, N]},
  \ {\tt\small column\_stochastic\_matrix[M, N]}, 
\item \myemph{Arrays:}  of any type (and dimensionality) \ {\tt\small array[N] T}
\end{subitemize}


\sld{Integers and reals}
%
\begin{itemize}
...
\sld{Arrays, vectors, and matrices}
%
\begin{itemize}
...
\sld{Statements with side effects}
%
\begin{itemize}
...
\sld{Distribution statement increments target}
%
\begin{itemize}
...
\item \texttt{target += poisson\_lupdf(y | lambda);}
\end{itemize}
...
\sld{Target increments}
%
\begin{itemize}
\item May access target or use sampling statements
...
\sld{Reverse-mode automatic differentiation}
%
\begin{itemize}
...
\sld{Stan's reverse-mode autodiff}
%
\begin{itemize}
...
\sld{Forward-mode automatic differentiation}
%
\begin{itemize}
...
\item All higher-order derivative patterns available through \myemph{Stan Playground}.
\end{itemize}
...
\sld{Third-order derivatives (even more esoteric)}
%
\begin{itemize}
