---
title: BRMS - Air Pollution Example
jupyter: ir
---
...
```{r}
fit_complete_pool = brm(log_pm25 ~ 0 + log_sat, data=sites, cores=4, refresh=0)
```

```{r}
print(make_stancode(log_pm25 ~ 1 + log_sat, data=sites))
```
